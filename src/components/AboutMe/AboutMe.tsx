                                ...
                                <div className={'aboutMe__content-area-text-block'}>
                                    <div className={'aboutMe__content-area-text-block-item'}>
                                        ...
                                        <p className={'aboutMe__content-area-text-block-item-story'}>
                                            Мне всегда нравилось проводить слишком много времени за компьютером, и в 14
                                            лет
                                    ...
                                    <div className={'aboutMe__content-area-text-block-item'}>
                                        ...
                                        <p className={'aboutMe__content-area-text-block-item-story'}>
                                            В школе, в 10 классе я начал изучать книгу по C#, на тот момент я ещё не
                                            понимал как устроено программирование. На уроках информатики практиковал
                                            создание простых одностраничных WEB-проектов, без применения JavaScript, в
                                            частности это был однофайловый проект (странно вообще звучит), с одним
                                            файлом index.html, в котором длинна кода не превышала 500 строк.
                                        </p>
                                    </div>
                                    <div className={'aboutMe__content-area-text-block-item'}>
                                        <p className={'aboutMe__content-area-text-block-item-year'}>
                                    ...
                                    <div className={'aboutMe__content-area-text-block-item'}>
                                        ...
                                        <p className={'aboutMe__content-area-text-block-item-story'}>
                                            Учась на 3 курсе в колледже, я начал изучать активно Python на Udemy, а
                                            также купил пару книг по этому языку. Сделал несколько небольших приложений,
                                            таких как генератор паролей, музыкальный плеер, программа для сбора email
                                            адресов, а также консольную текстовую игру - виселица. Написав эти
                                            приложения, я уже намного осознанней и лучше начал понимать ООП. Через
                                            несколько месяцев я приобрёл книгу по Django и тренировался на ней
                                ...
                                <div className={'aboutMe__content-area-text-block'}>
                                    <div className={'aboutMe__content-area-text-block-item'}>
                                        ...
                                        <p className={'aboutMe__content-area-text-block-item-story'}>
                                            ...
                                            дипломного проекта, суть этого приложения была проста, дать возможность
                                            учителям
                                    ...
                                    <div className={'aboutMe__content-area-text-block-item'}>
                                        ...
                                        <p className={'aboutMe__content-area-text-block-item-story'}>
                                            ...
                                            <i className={'aboutMe__content-area-text-block-item-story-italic'}> фреймворк
                                                ...
                                                SASS/SCSS, Axios </i>
                                            . На данный момент это мой основной стэк технологий, и я позиционирую себя
                                            как
                                            <i className={'aboutMe__content-area-text-block-item-story-italic'}> Junior
                                                React
                                                разработчик</i>.
                                        </p>
                                    </div>
                                    <div className={'aboutMe__content-area-text-block-social'}>
                                        <div className={'aboutMe__content-area-text-block-social-group'}>
                                            <div className={'aboutMe__content-area-text-block-social-github'}>
                                                <img src={'./img/git.svg'} alt={'git'} className={'aboutMe__content-area-text-block-social-img'}/>
                                                <a target={'_blank'} href={'https://github.com/GroundGamer?tab=repositories'} className={'aboutMe__content-area-text-block-social-link'} rel={'noreferrer'}>
                                                    <i>GitHub</i>
                                                </a>
                                            </div>
                                            <div className={'aboutMe__content-area-text-block-social-hh'}>
                                                <img src={'./img/hh.svg'} alt={'hh'} className={'aboutMe__content-area-text-block-social-img'}/>
                                                <a target={'_blank'} href={'https://spb.hh.ru/resume/c94181f1ff044f3aac0039ed1f754d55655136'} className={'aboutMe__content-area-text-block-social-link'} rel={'noreferrer'}>
                                                    <i>HeadHunter</i>
                                                </a>
                                            </div>
                                            <div className={'aboutMe__content-area-text-block-social-codewars'}>
                                                <img src={'./img/codewars.svg'} alt={'codewars'} className={'aboutMe__content-area-text-block-social-img'}/>
                                                <a target={'_blank'} href={'https://www.codewars.com/users/Ground_Gamer'} className={'aboutMe__content-area-text-block-social-link'} rel={'noreferrer'}>
                                                    <i>CodeWars</i>
                                                </a>
                                            </div>
                                            <div className={'aboutMe__content-area-text-block-social-vk'}>
                                                ...
                                                <a target={'_blank'} href={'https://vk.com/e.parfenyuk'} className={'aboutMe__content-area-text-block-social-link'} rel={'noreferrer'}>
                                                    <i>Vkontakte</i>
                                                </a>
                                            </div>
                                            <div className={'aboutMe__content-area-text-block-social-stackoverflow'}>
                                                <img src={'./img/so.svg'} alt={'stackoverflow'}
                                                     className={'aboutMe__content-area-text-block-social-img'}/>
                                                <a target={'_blank'} href={'https://stackoverflow.com/users/12204830/ground-gamer'} className={'aboutMe__content-area-text-block-social-link'} rel={'noreferrer'}>
                                                    <i>Stack Overflow</i>
                                                </a>
                                            </div>
                                        </div>
